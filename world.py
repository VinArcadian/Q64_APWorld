...
from . import options as quest64_options  # rename due to a name conflict with World.options
...
class Quest64World(World):
    """
    Quest 64 is a turn-based RPG about collecting and utilizing elemental magic to save the world.
    """
    ...
    web = web_world.Quest64WebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "apquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = quest64_options.Quest64Options
    options: quest64_options.Quest64Options  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    origin_region_name = "Earth Region"
    ...
    def create_item(self, name: str) -> items.Quest64Item:

...
DEFAULT_ITEM_CLASSIFICATIONS = {
    "Spirit Light": ItemClassification.filler,
    "Fresh Bread": ItemClassification.filler,
    "Honey Bread": ItemClassification.filler,
    "Healing Potion": ItemClassification.filler,
    "Dragon Potion": ItemClassification.filler,
    "Dew Drop": ItemClassification.filler,
    "Mint Leaves": ItemClassification.filler,
    "Heroes Drink": ItemClassification.filler,
    "Silent Flute": ItemClassification.filler,
    "Celine's Bell": ItemClassification.filler,
    "Replica": ItemClassification.filler,
    "Giant's Shoes": ItemClassification.filler,
    "Silver Amulet": ItemClassification.filler,
    "Golden Amulet": ItemClassification.filler,
    "White Wings": ItemClassification.useful,
    "Yellow Wings": ItemClassification.useful,
    "Blue Wings": ItemClassification.useful,
    "Green Wings": ItemClassification.useful,
    "Red Wings": ItemClassification.useful,
    "Black Wings": ItemClassification.useful,
    "Earth Orb": ItemClassification.progression,
    "Wind Jade": ItemClassification.progression,
...
def create_all_items(world: Quest64World) -> None:
